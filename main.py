from question_generation.app.QuestionGeneration import QuestionGenerator
from question_generation.api.question_generator import VisualQuestionGenerator
import random
import json
...
if __name__ == '__main__':
    ...
    image_path = "datasets/charts/chart1.jpg"

    vqg =VisualQuestionGenerator()
    vqg._process_inputs(image_path,"")
    question = vqg._generate_question(image_path)
    answer = vqg._generate_answer(image_path,question)
    print(question)
